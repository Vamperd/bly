...
- 实现提交：外层`tiny-model@b5f1e27fbefb68ce32d14dee3d342fa6f9011cca`，固定effective-batch收尾提交`03a16bab89a31a0ba9f175481cd86eae736ee742`；提交后工作树只保留两个既有未跟踪嵌套仓库目录，未修改SONIC或IsaacLab。
